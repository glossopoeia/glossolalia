...
t-frequencies       : /"Frequencies" /t-plus-newl (t-group-frequencies /t-star-newl)*
t-group-frequencies : GROUP-NAME /":" /t-plus-newl (t-sound-frequency /t-star-newl)+
t-sound-frequency   : t-sound-names /"=" PERCENTAGE
@t-sound-names      : SOUND-NAME (/"," SOUND-NAME)*

t-generate : /"Generate" /t-plus-newl t-seed /t-star-newl t-count /t-star-newl
